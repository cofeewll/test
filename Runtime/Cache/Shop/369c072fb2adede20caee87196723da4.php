...
<script type="text/javascript" charset="utf-8" src="/Public/Static/kindeditor/lang/zh_CN.js"></script>
 ...
 <style type="text/css">
    #album .uploadify-queue-item{
        height: 230px;
    }
    #album .showthumbs img{
         max-height: 190px;
     }
 </style>
                ...
                <div class="tabs-container">
                    ...
                    <div class="ibox-content" style="border-top: 0;">
                        <form role="form" action="<?php echo U('Goods/addGoods');?>" id="form-add" class="form-horizontal">
                            ...
                            <input type="hidden" name="shopId" value="<?php echo ($_SESSION['shop_admin']['shop_auth']['shopId']); ?>"> 
                            <div class="tab-content">
                                <div id="tab-1" class="tab-pane active">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10 shot">
                                            <div>(支持:jpg、jpeg、png、gif； 尺寸：宽500*高500px；大小：限5M内)</div>
                                            <div id="img"></div>
                                        </div>
                                    </div>
                                    <div class="hr-line-dashed"></div>    
                                    ...
                                    <?php else: ?>
                                        <div class="form-group">
                                            <label class="col-sm-2">&nbsp;</label>
                                            <a class="btn btn-primary" href="javascript:showTab(2);">下一步</a>
                                        </div><?php endif; ?>
                                ...
                                <div id="tab-2" class="tab-pane">
                                    ...
                                    <?php else: ?>
                                        <div class="form-group">
                                            <label class="col-sm-2">&nbsp;</label>
                                            <a class="btn btn-primary" href="javascript:showTab(3);">下一步</a>
                                        </div><?php endif; ?>
                                ...
                                <div id="tab-3" class="tab-pane">
                                    ...
                                    <?php else: ?>
                                        <div class="form-group">
                                            <label class="col-sm-2">&nbsp;</label>
                                            <a class="btn btn-primary" href="javascript:showTab(4);">下一步</a>
                                        </div><?php endif; ?>
                                </div>
    ...
    $("#fid").change(function(){
        ...
        if(fid){
            $.ajax({
                    ...
                    data:{fid:fid},
                    dataType:'json' ,
                    url:"<?php echo U('Shop/Goods/ajaxGetCates');?>",
                    success:function(data){  
                       $("#cid").html('');
                       console.log(data);
    ...
    function showTab(num){
        $(".ibox-title ul>li").find('a[href="#tab-'+num+'"]').click();
    }
    </script>
