            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-content">
                        <form role="form" action="<?php echo U('Article/add');?>" id="form-add" class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10 shot">
                                    <select name="type"  class="form-control" style="width: 60%;">
                                        <option value="">请选择</option>
                                        <option value="1" <?php if(!empty($info)): if(($info["type"]) == "1"): ?>selected<?php endif; endif; ?>>帮助中心</option>
                                        <option value="2" <?php if(!empty($info)): if(($info["type"]) == "2"): ?>selected<?php endif; endif; ?>>其他</option>
                                    </select>
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10 shot">
                                    <textarea id="editor" name="context" class="form-control" style="width: 80%;height:300px;"><?php if(!empty($info)): echo ($info['context']); endif; ?></textarea>
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
