            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-content">
                        <form role="form" action="<?php echo U('Banner/add');?>" id="form-add" class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10 shot">
                                    <div>(支持:jpg、jpeg、png、gif； 尺寸：宽750*高400px；大小：限5M内)</div>
                                    <div id="img"></div>
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <!-- <div class="form-group">
                                ...
                                <div class="col-sm-10 shot">
                                    <textarea id="editor" name="content" class="form-control" style="width: 60%;height:300px;"><?php if(!empty($info)): ?>value="<?php echo ($info['content']); ?>"<?php endif; ?></textarea>
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div> -->
